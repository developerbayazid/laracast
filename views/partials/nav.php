            ...
            <div class="ml-3">
                <?php if( $_SESSION['user'] ?? false ): ?>
                    <form action="/session" method="POST">
                        ...
                        <button class="<?= urlIs('/session') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:cursor-pointer hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log Out</button>
                    </form>
                <?php endif; ?>        
            </div>
        </div>
